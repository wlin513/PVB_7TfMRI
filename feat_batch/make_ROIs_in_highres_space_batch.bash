...
seednames=("binConjunc_PvNxDECxRECxMONxPRI_vmpfc_resampled" "NAcc_resampled" "NAcc_resampled_left" "NAcc_resampled_right" "activation_GLM1_pre_1_win_vs_loss_mean_mPFC_82" "atlas-vta_hem-bi_proba-27_resampled_thr01" "bilateral_Hb_15" "left_Hb_15" "right_Hb_15")
...
#for b in `seq 1 ${#blklist[@]}`;do
   ...
   for nseed in `seq 1 ${#seednames[@]}`; do
       ...
       applywarp --ref=highres.nii.gz --in=${base_dir}/ROIs/${seednames[nseed-1]}.nii.gz --warp=standard2highres_warp.nii.gz  --out=${subject}_${seednames[nseed-1]} --interp=nn	   
   done
#done