...
for ncontrast in `seq 1 ${#contrast_names[@]}`; do
  ...
  for i in `seq 1 ${#subjectlist[@]}`; do 
   ...
   # lefthb[$i]=`fslmeants -i  ${base_dir}/second_level/${glm}_${PRE}/${subjectlist[i-1]}.gfeat/cope$c.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROI_analysis/${subjectlist[i-1]}/left_Hb_mni.nii* ` 
   # righthb[$i]=`fslmeants -i  ${base_dir}/second_level/${glm}_${PRE}/${subjectlist[i-1]}.gfeat/cope$c.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROI_analysis/${subjectlist[i-1]}/right_Hb_mni.nii* ` 
   # bilateralhb[$i]=`fslmeants -i  ${base_dir}/second_level/${glm}_${PRE}/${subjectlist[i-1]}.gfeat/cope$c.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROI_analysis/${subjectlist[i-1]}/bilateral_Hb_mni.nii* `
   ...
   # activation_right_insula[$i]=`fslmeants -i  ${base_dir}/second_level/${glm}_${PRE}/${subjectlist[i-1]}.gfeat/cope$c.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROIs/GLM1_pre_1_loss_amount_activation_right_insula_mask.nii*`
   # activation_ACC[$i]=`fslmeants -i  ${base_dir}/second_level/${glm}_${PRE}/${subjectlist[i-1]}.gfeat/cope$c.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROIs/GLM1_pre_1_win_amount_activation_ACC_mask.nii*`
   # activation_left_VS[$i]=`fslmeants -i  ${base_dir}/second_level/${glm}_${PRE}/${subjectlist[i-1]}.gfeat/cope$c.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROIs/GLM1_pre_1_win_amount_activation_left_VS_mask.nii*`
   # activation_left_lOFC[$i]=`fslmeants -i  ${base_dir}/second_level/${glm}_${PRE}/${subjectlist[i-1]}.gfeat/cope$c.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROIs/GLM1_pre_1_win_amount_activation_left_lOFC_mask.nii*`
   # activation_right_VS[$i]=`fslmeants -i  ${base_dir}/second_level/${glm}_${PRE}/${subjectlist[i-1]}.gfeat/cope$c.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROIs/GLM1_pre_1_win_amount_activation_right_VS_mask.nii*`
   ...
   # echo ${activation_ACC[@]} >${base_dir}/ROI_analysis/activation_ACC_${cope_names[c-1]}_${contrast_names[ncontrast-1]}.txt
   # echo ${activation_left_VS[@]} >${base_dir}/ROI_analysis/activation_left_VS_${cope_names[c-1]}_${contrast_names[ncontrast-1]}.txt
   # echo ${activation_left_lOFC[@]} >${base_dir}/ROI_analysis/activation_left_lOFC_${cope_names[c-1]}_${contrast_names[ncontrast-1]}.txt
