...
for ncontrast in `seq 1 ${#contrast_names[@]}`; do
  ...
  for i in `seq 1 ${#subjectlist[@]}`; do 
   ...
   activation_left_insula[$i]=`fslmeants -i  ${base_dir}/second_level/${glm}_${PRE}/${subjectlist[i-1]}.gfeat/cope$c.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROIs/GLM2_pre_1_chosen_NPE_activation_left_insula_mask.nii*`
   ...
   echo ${activation_left_insula[@]} >${base_dir}/ROI_analysis/activation_left_insula_${cope_names[c-1]}_${contrast_names[ncontrast-1]}.txt
