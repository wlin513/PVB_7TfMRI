...
cp -r /mnt/h/2023_Peking_DRL/preprocessing/${PRE}/${subject}/${blklist[$i]}.feat ${fir_dir}/first_level/PPI_${seedname}_${glm}_${contrastname}_${PRE}/${subject}
