...
for ncontrast in `seq 1 ${#contrast_names[@]}`; do
  ...
  for i in `seq 1 ${#subjectlist[@]}`; do 
   ...
   # lefthb[$i]=`fslmeants -i  ${base_dir}/second_level/${glm}_${PRE}/${subjectlist[i-1]}.gfeat/cope$c.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROI_analysis/${subjectlist[i-1]}/left_Hb_mni.nii* -w` 
   # righthb[$i]=`fslmeants -i  ${base_dir}/second_level/${glm}_${PRE}/${subjectlist[i-1]}.gfeat/cope$c.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROI_analysis/${subjectlist[i-1]}/right_Hb_mni.nii* -w` 
   # bilateralhb[$i]=`fslmeants -i  ${base_dir}/second_level/${glm}_${PRE}/${subjectlist[i-1]}.gfeat/cope$c.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROI_analysis/${subjectlist[i-1]}/bilateral_Hb_mni.nii* -w`
   ...
   # bilateral_accumbens[$i]=`fslmeants -i  ${base_dir}/second_level/${glm}_${PRE}/${subjectlist[i-1]}.gfeat/cope$c.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROIs/harvardoxford-subcortical_prob_Bilateral_Accumbens.nii*`
    # bilateral_nacc[$i]=`fslmeants -i  ${base_dir}/second_level/${glm}_${PRE}/${subjectlist[i-1]}.gfeat/cope$c.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROIs/NAcc_resampled.nii*`
	# left_nacc[$i]=`fslmeants -i  ${base_dir}/second_level/${glm}_${PRE}/${subjectlist[i-1]}.gfeat/cope$c.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROIs/NAcc_resampled_left.nii*`
	# right_nacc[$i]=`fslmeants -i  ${base_dir}/second_level/${glm}_${PRE}/${subjectlist[i-1]}.gfeat/cope$c.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROIs/NAcc_resampled_right.nii*`
...
#	activation_left_VS_neg_NPE[$i]=`fslmeants -i  ${base_dir}/second_level/${glm}_${PRE}/${subjectlist[i-1]}.gfeat/cope$c.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROIs/GLM2_pre_2_chosen_NPE_negative_activation_left_VS_mask.nii*`
   ...
   # echo ${bilateral_accumbens[@]} >${base_dir}/ROI_analysis/bilateral_accumbens_${cope_names[c-1]}_${contrast_names[ncontrast-1]}.txt
    ...
    # echo ${bilateral_nacc[@]} >${base_dir}/ROI_analysis/bilateral_NAcc_${cope_names[c-1]}_${contrast_names[ncontrast-1]}.txt
	# echo ${left_nacc[@]} >${base_dir}/ROI_analysis/left_NAcc_${cope_names[c-1]}_${contrast_names[ncontrast-1]}.txt
	# echo ${right_nacc[@]} >${base_dir}/ROI_analysis/right_NAcc_${cope_names[c-1]}_${contrast_names[ncontrast-1]}.txt
   ...
   # echo ${activation_left_VS_neg_NPE[@]} >${base_dir}/ROI_analysis/activation_left_VS_neg_NPE_${cope_names[c-1]}_${contrast_names[ncontrast-1]}.txt
  done
done