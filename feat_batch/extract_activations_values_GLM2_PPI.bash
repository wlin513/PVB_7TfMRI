...
for ncontrast in `seq 1 ${#contrast_names[@]}`; do
    ...
    for i in `seq 1 ${#subjectlist[@]}`; do 
     ...
     bilateral_VTA[$i]=`fslmeants -i  ${base_dir}/second_level/PPI_${glm}_${cope_name}_${seedname}_${PRE}/${subjectlist[i-1]}.gfeat/cope1.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROIs/atlas-vta_hem-bi_proba-27_resampled_thr01.nii*`
	 left_VTA[$i]=`fslmeants -i  ${base_dir}/second_level/PPI_${glm}_${cope_name}_${seedname}_${PRE}/${subjectlist[i-1]}.gfeat/cope1.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROIs/atlas-vta_hem-l_proba-27_resampled_thr01.nii*`
	 right_VTA[$i]=`fslmeants -i  ${base_dir}/second_level/PPI_${glm}_${cope_name}_${seedname}_${PRE}/${subjectlist[i-1]}.gfeat/cope1.feat/stats/zstat$ncontrast.nii.gz -m ${base_dir}/ROIs/atlas-vta_hem-r_proba-27_resampled_thr01.nii*`
