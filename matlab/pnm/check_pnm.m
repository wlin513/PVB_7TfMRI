function check_pnm(pnmdir,subname,blkname)

%function to graphically check performance of pnm output
% load data

    data=load([pnmdir,subname,'/',blkname,...
        '/',subname,'_',blkname,'_pnm_matlab.txt']);
    run_string=[pnmdir,subname,'/',blkname,...
        '/',subname,'_',blkname,'_pnm_pnm_stage2'];
...
gdata.fullname=[subname];
gdata.fullpath=[pnmdir,subname,'/',blkname,'/',subname,'_',blkname];
